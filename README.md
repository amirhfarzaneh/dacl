...
2. Download ms-celeb pretrained model for weight initialization: [Google Drive](https://drive.google.com/file/d/1H421M8mosIVt8KsEWQ1UuYMkQS8X1prf/view?usp=sharing)
